                    ...
                    <div class="row">
                        ...
                        <div  class="panel-heading" style="margin-right: 2%; margin-left: 0%;">
                            <div class="well well-sm" style="height: 70px; width:100%; margin-left: 0%;">
                                ...
                                <a class="btn btn-success" href="{{URL::to('/adminpanel/team/create')}}" style="height: 40px;font-size: 18px;float: right;">Add new Team member</a>
                                    ...
                                    <div class="product-image-wrapper smth" style="box-shadow: 1px 2px 2px gray; height: 340px; width: 200px; margin-left: 10%;">
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <a href="{{URL::to('/adminpanel/team/index')}}"   style="font-size: 20px;color: orange;">
                                                    @if(isset($team->image->path))

                                                        <img src="{{$team->getImageUrlAttribute()}}" alt="text" >  @endif
                                                    <hr> </a>

                                                <p><i>{{$team->name_ru}}</i></p>
                                                <p><i>{{$team->profession_ru}}</i></p>
                                                <p><i>{{$team->text_ru}}</i></p></a>
                                            </div>


                                            <div class="row">
                                                <div class="col-xs-12 col-md-6">
                                                    <form action="{{ URL::to('/adminpanel/team/'.$team->id) }}" method="POST" id = "deleteStore">
                                                ...
                                                <div class="col-xs-12 col-md-6">
                                                    <a href="{{ URL::to('/adminpanel/team/'.$team->id.'/edit') }}" class="btn btn-danger" style="background-color: #5fbe28; border: 0;"><i class="fa fa-pencil-square-o"> </i> Edit</a>
                                                </div>
                        ...
                        <div class="container">
                            {{$teams->appends(request()->only('searchtext'))->render()}}
                        </div>
                    </div>
                </div>
            </div>
